...
defmodule Tensorflow.ResourceHandleProto do
  ...
  @type t :: %__MODULE__{
          ...
          dtypes_and_shapes: [Tensorflow.ResourceHandleProto.DtypeAndShape.t()],
  ...
  field :dtypes_and_shapes, 6, repeated: true, type: Tensorflow.ResourceHandleProto.DtypeAndShape
